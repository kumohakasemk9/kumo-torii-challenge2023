...
class logic4511(Elaboratable): #module logic4511
	...
	def elaborate(self, platform) -> Module:
		...
		#		m.d.comb += _q.eq(0b1111011)
			#YAY Python code + torii-HDL collab!!
			#7segment decorder output in numeric order
			OUTPUTS = (0b1111110, 0b0110000, 0b1101101, 0b1111001, 0b0110011, 0b1011011,
				0b1011111, 0b1110000, 0b1111111, 0b1111011)
			for i in range(10):
				with m.Case(i):
					m.d.comb += _q.eq(OUTPUTS[i])
			with m.Default():
				m.d.comb += _q.eq(0)
